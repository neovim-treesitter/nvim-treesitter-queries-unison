# nvim-treesitter-queries-unison

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-unison/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-unison/actions/workflows/validate.yml)

Neovim tree-sitter queries for **unison**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-unison",
...
- [ ] Changes are scoped to `unison` — do not include files for other languages
